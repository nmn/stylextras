...
export const componentCatalog = [
  ...
  stable(
    ...
    'enhanced',
    'bridge',
    'Native modal dialog positioned against its trigger.',
  ),
  ...
  stable(
    ...
    'enhanced',
    'bridge',
    'Native dialog with an opt-in legacy invoker bridge.',
  ),
  stable(
    'Direction',
    'direction',
  ...
  stable('Tabs', 'tabs', 'client', 'none', 'Keyboard tab controller with deferred-panel support.'),
  ...
  experimental(
    ...
    'native',
    'native',
    'Native color input with area styling.',
  ),
  ...
  experimental(
    ...
    'native',
    'native',
    'Native color input with wheel styling.',
  ),

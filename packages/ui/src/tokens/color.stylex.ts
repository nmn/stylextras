...
export const color_derived = stylex.defineVars({
  ...
  primaryActive: mix(color_core.brand, color_core.fg, 94),
  primaryForeground: color_core.fgOnBrand,

  secondary: mix(color_core.bg, color_core.tone, 90),
  secondaryHover: mix(color_core.bg, color_core.tone, 86),
  secondaryActive: mix(color_core.bg, color_core.fg, 96),
  ...
  dangerHover: mix(color_core.danger, color_core.bg, 88),
  dangerActive: mix(color_core.danger, color_core.fg, 94),
  infoHover: mix(color_core.info, color_core.bg, 88),
  infoActive: mix(color_core.info, color_core.fg, 94),
  successHover: mix(color_core.success, color_core.bg, 88),
  successActive: mix(color_core.success, color_core.fg, 94),
  warningHover: mix(color_core.warning, color_core.bg, 88),
  warningActive: mix(color_core.warning, color_core.fg, 94),
...
export const colors = stylex.defineConsts({
  ...
  secondaryActive: color_derived.secondaryActive,
  ...
  infoHover: color_derived.infoHover,
  infoActive: color_derived.infoActive,
  successHover: color_derived.successHover,
  successActive: color_derived.successActive,
  warningHover: color_derived.warningHover,
  warningActive: color_derived.warningActive,
  dangerHover: color_derived.dangerHover,
  dangerActive: color_derived.dangerActive,

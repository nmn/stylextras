...
export type ColorFieldProps = Omit<BaseProps, "className" | "style" | "type"> & { sx?: StyleXStyles };
 ...
 */
export function ColorField({ sx, ...props }: ColorFieldProps) { return <input {...props} type="color" {...stylex.props(styles.base, sx)} />; }

const styles = stylex.create({ base: { width: spacing["4xl"], height: spacing["3xl"], padding: 0 } });

...
export default function Example() {
  return (
    <>
      <DemoFrame title="Simple table" description="Table should show the component plainly as tabular structure.">
        <Table>
          <thead><tr><th>Name</th><th>Type</th><th>Usage</th></tr></thead>
          <tbody>

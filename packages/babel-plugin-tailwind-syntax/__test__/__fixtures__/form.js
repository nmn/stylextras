  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Detailed pool data for the selected Uniswap slot0.</CardDescription>
      </CardHeader>
      <CardContent>
        <div className={cn('grid grid-cols-2 gap-4 text-sm', xstyle)}>
          ...
          <div className="flex flex-col space-y-1.5">
            <Label htmlFor="observationCardinality">Observation Cardinality</Label>
            <Input disabled id="observationCardinality" placeholder="Observation Cardinality" />
          </div>
          <div className="flex flex-col space-y-1.5">
            <Label htmlFor="observationCardinalityNext">Observation Cardinality Next</Label>
            <Input
              disabled

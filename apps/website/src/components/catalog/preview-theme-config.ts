...
export type StructuralThemeSelection = Omit<PreviewThemeSelection, 'appearance' | 'color'>
export type PreviewStylePreset = StructuralThemeSelection & {
  color?: ColorThemeName
}

export const previewStylePresets: Record<PreviewStyleName, PreviewStylePreset> = {
  vega: {
    blur: 'subtle',
    elevation: 'soft',
    motion: 'standard',

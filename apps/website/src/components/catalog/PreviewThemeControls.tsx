...
const typographyThemeNames = Object.keys(
  typographyThemes,
) as TypographyThemeName[];
const elevationThemeNames = Object.keys(
  elevationThemes,
...
export function PreviewThemeControls({
  ...
  return (
    ...
    >
      <div {...stylex.props(styles.legend)} id={`${id}-legend`}>
        Theme controls
      </div>
      <div {...stylex.props(styles.grid)}>
        <ThemeSelect
          ...
          value={styleName}
          onChange={(event) =>
            onStyleChange(event.currentTarget.value as PreviewStyleSelection)
          }
        />
        <ThemeSelect
          label="Appearance"
          ...
          onChange={(event) =>
            onSelectionChange('appearance', event.currentTarget.value)
          }
        />
        <ThemeSelect
          label="Color theme"
          ...
          onChange={(event) =>
            onSelectionChange('color', event.currentTarget.value)
          }
        />
        <ThemeSelect
          label="Spacing theme"
          ...
          onChange={(event) =>
            onSelectionChange('spacing', event.currentTarget.value)
          }
        />
        <ThemeSelect
          label="Radius theme"
          ...
          onChange={(event) =>
            onSelectionChange('radius', event.currentTarget.value)
          }
        />
        <ThemeSelect
          ...
          onChange={(event) =>
            onSelectionChange('typography', event.currentTarget.value)
          }
        />
        <ThemeSelect
          label="Stroke theme"
          ...
          onChange={(event) =>
            onSelectionChange('stroke', event.currentTarget.value)
          }
        />
        <ThemeSelect
          ...
          onChange={(event) =>
            onSelectionChange('elevation', event.currentTarget.value)
          }
        />
        <ThemeSelect
          label="Blur theme"
          ...
          onChange={(event) =>
            onSelectionChange('blur', event.currentTarget.value)
          }
        />
        <ThemeSelect
          label="Motion theme"
          ...
          onChange={(event) =>
            onSelectionChange('motion', event.currentTarget.value)
          }
        />
      </div>
    </fieldset>
